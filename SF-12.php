...
<html>
	...
	<body>
		...
		<?php //debut question2
			} elseif (isset($_POST['Exce1']) or isset($_POST['TB1']) or isset($_POST['B1']) or isset($_POST['Méd1']) or isset($_POST['Mauv1'])) { //si sur la question précédente un des boutons a été pressé (passage à la question suivante)
		...
		<?php //debut question3
			} elseif (isset($_POST['Oui,bcp2']) or isset($_POST['Oui,peu2']) or isset($_POST['Non2'])){
				if (isset($_POST['Non2'])) {
		...
		<?php //debut question4
			} elseif (isset($_POST['Oui,bcp3']) or isset($_POST['Oui,peu3']) or isset($_POST['Non3'])){
				if (isset($_POST['Non3'])) {
		...
		<?php //debut question2
			} elseif (isset($_POST['tjrs4']) or isset($_POST['plupart4']) or isset($_POST['svt4']) or isset($_POST['prf4']) or isset($_POST['jms4'])) { //si sur la question précédente un des boutons a été pressé (passage à la question suivante)
		...
		<?php //debut question2
			} elseif (isset($_POST['tjrs5']) or isset($_POST['plupart5']) or isset($_POST['svt5']) or isset($_POST['prf5']) or isset($_POST['jms5'])) { //si sur la question précédente un des boutons a été pressé (passage à la question suivante)
		...
		<?php //debut question2
			} elseif (isset($_POST['tjrs6']) or isset($_POST['plupart6']) or isset($_POST['svt6']) or isset($_POST['prf6']) or isset($_POST['jms6'])) { //si sur la question précédente un des boutons a été pressé (passage à la question suivante)
		...
		<?php //debut question2
			} elseif (isset($_POST['tjrs7']) or isset($_POST['plupart7']) or isset($_POST['svt7']) or isset($_POST['prf7']) or isset($_POST['jms7'])) { //si sur la question précédente un des boutons a été pressé (passage à la question suivante)
		...
		<?php //debut question2
			} elseif (isset($_POST['pdt8']) or isset($_POST['petit8']) or isset($_POST['moy8']) or isset($_POST['bcp8']) or isset($_POST['enorm8'])) { //si sur la question précédente un des boutons a été pressé (passage à la question suivante)
				if (isset($_POST['pdt8'])) { 
		...
		<?php //debut question2
			} elseif (isset($_POST['tjrs9']) or isset($_POST['plupart9']) or isset($_POST['svt9']) or isset($_POST['prf9']) or isset($_POST['jms9'])) { //si sur la question précédente un des boutons a été pressé (passage à la question suivante)
		...
		<?php //debut question2
			} elseif (isset($_POST['tjrs10']) or isset($_POST['plupart10']) or isset($_POST['svt10']) or isset($_POST['prf10']) or isset($_POST['jms10'])) { //si sur la question précédente un des boutons a été pressé (passage à la question suivante)
		...
		<?php //debut question2
			} elseif (isset($_POST['tjrs11']) or isset($_POST['plupart11']) or isset($_POST['svt11']) or isset($_POST['prf11']) or isset($_POST['jms11'])) { //si sur la question précédente un des boutons a été pressé (passage à la question suivante)
		...
		<?php //debut question2
			} elseif (isset($_POST['tjrs12']) or isset($_POST['plupart12']) or isset($_POST['svt12']) or isset($_POST['prf12']) or isset($_POST['jms12'])) { //si sur la question précédente un des boutons a été pressé (passage à la question suivante)
